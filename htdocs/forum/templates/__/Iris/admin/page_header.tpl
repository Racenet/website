...
<body bgcolor="#{T_BODY_BGCOLOR}" text="#000000" link="#{T_BODY_LINK}" vlink="#{T_BODY_VLINK}">
<a name="top"></a>
<center>For support for this phpBB Style visit <a href="http://www.phpbbstyles.com">phpBBStyles.com</a><br /><br /></center>
