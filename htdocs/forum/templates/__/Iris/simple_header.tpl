...
<body bgcolor="#{T_BODY_BGCOLOR}" text="#000000" link="#{T_BODY_LINK}" vlink="#{T_BODY_VLINK}" marginwidth="0" marginheight="0" leftmargin="0" topmargin="0" /><table border="0" cellspacing="0" cellpadding="0" width="100%" height="100%" class="simpletable">
